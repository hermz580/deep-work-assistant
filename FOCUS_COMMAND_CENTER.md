...
The Focus Command Center is a local browser interface for the existing Deep Work Assistant engine. It reads and writes the same local JSONL and SQLite files as the CLI; it does not create a cloud account or duplicate data store.
